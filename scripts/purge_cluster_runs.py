...
Usage::
    ...
    python scripts/purge_cluster_runs.py --all
    python scripts/purge_cluster_runs.py 42
    python scripts/purge_cluster_runs.py --all --dry-run
"""
...
def _run_ids(engine, *, run_id: int | None, all_runs: bool) -> list[int]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Remove clustering runs from archive.db.")
